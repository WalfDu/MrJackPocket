...
public class JetonEchanger extends Jetons {
    ...
    public void action(Detectives[] listeDetectives, District[][] board, String joueurActuel) {
        System.out.println(
                "Quelle est la 1ere tuile que vous voulez echanger (entrez l'abscisse puis l'ordonnee de la tuile)");
        int abscisse = scanner.nextInt() - 1;
        int ordonnee = scanner.nextInt() - 1;
        System.out.println(
                "Quelle est la 2eme tuile que vous voulez echanger (entrez l'abscisse puis l'ordonnee de la tuile)");
